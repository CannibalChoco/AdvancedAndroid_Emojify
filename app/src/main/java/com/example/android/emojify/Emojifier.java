...
class Emojifier {
    ...
    // over the face.
    public static Bitmap addBitmapToFace(Bitmap backgroundBitmap, Bitmap emojiBitmap,
                                         Face face){
        // Initialize results bitmap to be a mutable copy of of the original image
